...
urlpatterns = [
    ...
    url(r'call/delete/$', login_required(views.DeleteCallView.as_view()), name="calldelete"),
    ###Companies###
    ...
    url(r'company/delete/$', login_required(views.DeleteCompanyView.as_view()), name="companydelete"),
    url(r'company/update/$', login_required(views.UpdateCompanyView.as_view()), name="companyupdate"),
    ###Stage###
    ...
    url(r'stage/delete/$', login_required(views.DeleteStageView.as_view()), name="stagedelete"),
    url(r'stage/update/$', login_required(views.UpdateStageView.as_view()), name="stageupdate"),
    ###Contact###
    ...
    url(r'contact/delete/$', login_required(views.DeleteContactView.as_view()), name="contactdelete"),
    url(r'contact/update/$', login_required(views.UpdateContactView.as_view()), name="contactupdate"),
    ###Reminder###
    ...
    url(r'reminder/delete/$', login_required(views.DeleteReminderView.as_view()), name="reminderdelete"),
    url(r'reminder/update/$', login_required(views.UpdateReminderView.as_view()), name="reminderupdate"),
    ###Opportunity###
